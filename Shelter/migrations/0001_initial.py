# Generated by Django 3.1 on 2021-03-17 21:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('Moderator', 'Moderator'), ('Client', 'Client'), ('Owner', 'Owner'), ('Volunteer', 'Volunteer')], default='Client', max_length=9)),
                ('sex', models.CharField(choices=[('male', 'мужской'), ('female', 'женский')], default='женский', max_length=10, verbose_name='пол')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(default='images/profile_image.jpg', upload_to=Shelter.models.user_directory_path, verbose_name='Файлы')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='Shelter.pet', verbose_name='Питомец')),
